...
class Client(Socket):
    ...
    async def send_data(self, data=None):
        while True:
            message = await self.generel_loop.run_in_executor(None, input, ":::")
            if not self.is_working:
                return
    ...
    async def main(self):
        ...
        await asyncio.gather(
            ...
            self.generel_loop.create_task(self.listen_socket(self.socket)),
            self.generel_loop.create_task(self.send_data())
